...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> implements OnNoteItemClickListener {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView loactionTextView;
        TextView loactionTextView2;
        ...
        public ViewHolder(View itemView,final OnNoteItemClickListener listener, int layoutType) {
            ...
            loactionTextView = itemView.findViewById(R.id.locationTextView);
            loactionTextView2 = itemView.findViewById(R.id.contentsTextView2);
        ...
        public void setItem(Note item){
            ...
            loactionTextView.setText(item.getAddress());
            loactionTextView2.setText(item.getAddress());
